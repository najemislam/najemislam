...
export function RegisterForm({ onSuccess, onSwitchToLogin }: RegisterFormProps) {
    ...
    try {
      const response = await fetch('/api/auth/register', {
        ...
        body: JSON.stringify({
          ...
          orgType: formData.accountType === 'brand' ? formData.orgType : null,
          avatarUrl: '',
        })
      });
  ...
  const canProceedStep1 = isPersonal
    ...
    : formData.fullName && formData.username.length >= 3 && formData.since && formData.orgType && usernameStatus === 'available';
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-neutral-500 text-sm leading-snug">
                    For individuals. Includes Bio, Gender, and Date of Birth.
                  </span>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-neutral-500 text-sm leading-snug">
                    For businesses &amp; creators. Includes Description, Since, and Organization type.
                  </span>
                </div>
              </button>
            </motion.div>
            ...
            >
              ...
              {isBrand && (
                <>
                  ...
                  {/* Organization type */}
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold text-neutral-500 uppercase tracking-[0.1em] ml-1">Type</label>
                    <div className="grid grid-cols-2 gap-3">
                      {['Solo', 'Organization'].map((t) => (
                        <button
                          key={t}
                          type="button"
